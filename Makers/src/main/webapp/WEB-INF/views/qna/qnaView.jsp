    ...
    <div class="container boardViewCT">
		...
		<c:if test="${not empty adm }">
		 ...
		 <table class="table">
			...
			<tr>
				<th>첨부파일</th>
				<td><img alt="${list.qfile }" src="${conPath }/qnaImg/${list.qfile}" style="width: 300px;"> </td>
			</tr>
			...
			<td colspan="6">
				...
				<c:if test="${not empty adm and list.qstep eq 0}"> 
						<button class="board_btn focus" onclick="location.href='${conPath}/QnA/qnaReplyView.do?qnum=${list.qnum }&pageNum=${pageNum}'">답변달기</button>
				</c:if>
