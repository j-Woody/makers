        ...
        <c:forEach items="${cartList}" var="list" varStatus="idx">
        	...
        	<td>
        		<input type="checkbox" name="ctnum" class="<%=i %>" value="${list.ctnum }">
       			...
       			<td>
       			<img src="${conPath }/mOrderImage/${list.mrimg }" alt="${list.mrimg }" style="width: 100px; height: 100px;" >
       			</td>
       			<td>
       			...
       			<td>
       			<button class="deleteCart btn btn-primary btn-lg btn-block" name="${list.ctnum}" >삭제</button>
       			</td>
        	</tr>	
        </c:forEach>
