...
public class QnAController {
	...
	public String qnaReply(QnA qna,MultipartHttpServletRequest mRequest,String pageNum) {
		...
		String path;
			...
			path = "redirect:mail.do?mid="+qna.getMid()+"&pageNum="+pageNum; //qna.getmid,
	...
	public String mail( final String mid,String pageNum, Model model){
		System.out.println("메일발송 ?��?��?��");
		MimeMessagePreparator message = new MimeMessagePreparator() {
			String content = 
					"  <h1>Makers 사이트에 문의하신 질문에 답변처리되었습니다.</h1>";
			...
			public void prepare(MimeMessage mimeMessage) throws Exception {
				...
				mimeMessage.setSubject("Makers 사이트에 문의하신 질문에 답변처리되었습니다.");
				mimeMessage.setText(content, "utf-8", "html");
			}
		};
		mailSender.send(message);
		model.addAttribute("sendResult", "메일발송");
